...
/**
 * The two backends' own marks, drawn in `currentColor`.
 *
 * Paths are the official marks from simple-icons (CC0), inlined rather than
 * added as a dependency — two `d` strings do not need a package.
 */
